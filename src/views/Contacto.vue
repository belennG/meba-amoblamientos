  ...
  <div>
    <BackgroundPhoto>
      <div class="wrapper flex">
        <div class="formulario-contacto-wrapper px-16 py-16">
        ...
        <div
          class="preguntas-frecuentes w-3/4 flex-cols inline"
          v-for="faq in faqs"
          :key="faq.id"
        >
          <div
          ...
          >
            <div class="faq-wrapper">
              ...
              <div class="h-auto w-30 respuesta bg-blue-500" v-if="showAnswer">
                <p>{{ faq.respuesta }}</p>
              </div>
            </div>
          </div>
  ...
  data() {
    return {
      faqs: [
        {
          id: 1,
          pregunta: "Trabajan en todo el pais?",
          respuesta:
