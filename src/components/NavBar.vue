<template>
  <div class="border-2 flex w-full bg-blue-300">
    <router-link :to="{ name: 'Inicio' }" class="navbar flex items-center w-30">
      <img src="@/assets/MEBAlogo.jpeg" alt="meba-logo" class="h-20 w-20" />
